...
Then we visualized the violent and property crimes by neighborhood shown on the graphs below.
...
Display a figure showing how the treatment variable impacted the outcome variable.![](kush graph.png)
